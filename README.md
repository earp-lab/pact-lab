...
The site has eleven pages: the home page, `/publications/`, `/publications/outputs/`, `/events/`, `/resources/`, `/services/`, `/people/`, `/contact/`, `/hops/`, `/methods/crep/`, and `/mapping/`. Each page file (`index.html`, `publications.html`, `outputs.html`, `events.html`, `resources.html`, `people.html`, `contact.html`, `hops.html`, `crep.html`, `services.html`, `mapping.html`) is short and only sets the title and pulls in the pieces below.
