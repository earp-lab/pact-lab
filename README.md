...
The site has twelve pages: the home page, `/publications/`, `/publications/outputs/`, `/events/`, `/resources/`, `/services/`, `/people/`, `/contact/`, `/hops/`, `/methods/crep/`, `/mapping/`, and `/hiring/`. Each page file (`index.html`, `publications.html`, `outputs.html`, `events.html`, `resources.html`, `people.html`, `contact.html`, `hops.html`, `crep.html`, `services.html`, `mapping.html`, `hiring.html`) is short and only sets the title and pulls in the pieces below.
